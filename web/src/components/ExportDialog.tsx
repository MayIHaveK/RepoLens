  ...
  return (
    <div className="modal-backdrop" onMouseDown={(event) => event.target === event.currentTarget && onClose()}>
      <div className="modal" role="dialog" aria-modal="true" aria-labelledby="export-title">
        ...
        <div className="privacy-banner"><ShieldCheck /><span><strong>固定保护项</strong>源代码、结构化文件名、邮箱、本机路径和凭据不会写入报告。</span></div>
        <div className="modal-options">
          ...
          <Toggle label="显示提交信息" description="提交标题本身可能包含作者写入的路径或名称。" checked={privacy.showCommitMessages} onChange={(value) => set('showCommitMessages', value)} />
